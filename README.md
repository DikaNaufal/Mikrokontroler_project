UAS-SistemMikrokontroler IoT Radar System (ESP32 Only) 
#23552011021
Proyek IoT Radar ini menggunakan ESP32 sebagai otak tunggal untuk mendeteksi objek di sekitar dengan sudut 
0
∘
 hingga 
180
∘
. Sensor ultrasonik diputar oleh motor servo, lalu data jarak dan sudutnya diproses dan langsung diunggah oleh ESP32 ke dashboard IoT secara real-time melalui Wi-Fi.
